...
function SignupContent() {
  ...
  const createUserProfile = async (uid: string, userEmail: string, displayName: string) => {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await createUserProfile(currentUser.uid, email, name);
    ...
    <div className="glass-panel" style={{ width: "100%", maxWidth: "440px", padding: "3rem 2.5rem" }}>
      <div style={{ textAlign: "center", marginBottom: "2rem" }}>
        ...
        <p style={{ color: "var(--text-secondary)", fontSize: "0.95rem" }}>
          Signing up for the <span className="gradient-text" style={{ fontWeight: "700" }}>{plan === "pro" ? "Pro" : "Free"} Plan</span>
        </p>
      </div>
